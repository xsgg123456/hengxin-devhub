...
export const mapProject = (project: Project & { members: ProjectMember[] }) => ({
  ...
  firstRequestedOn: date(project.firstRequestedOn),
  businessOwnerId: project.businessOwnerId,
  description: project.description,
  migrationVerified: project.migrationVerified,
  name: project.name,
  ...
  acceptanceOwnerId: project.acceptanceOwnerId,
  acceptanceStatus: project.acceptanceStatus,
  acceptanceSubmittedAt: project.acceptanceSubmittedAt?.toISOString() ?? null,
  acceptanceSummary: project.acceptanceSummary,
  acceptanceUrl: project.acceptanceUrl,
  acceptanceRound: project.acceptanceRound,
  acceptanceHistory: Array.isArray(project.acceptanceHistory) ? project.acceptanceHistory : [],
